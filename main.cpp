...
#pragma omp parallel for
    ...
    std::cout << "#pragma omp parallel for Elapsed time: " << elapsed_time.count() << " ms" << std::endl;
    // Print the result
...
#pragma omp parallel for simd
    ...
    std::cout << "#pragma omp parallel for simd num_threads(16) Elapsed time: " << elapsed_time.count() << " ms" << std::endl;
    ...
    cl_int status;
    cl_int err;
    int d = 1; // 0 1st device ,1 2nd device
    // Get the platform
